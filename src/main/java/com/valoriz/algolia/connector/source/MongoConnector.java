...
import com.valoriz.algolia.connector.model.QueryRequestBody;
...
public class MongoConnector implements NoSqlConnector {
    ...
    /**
     * This method is used to create _id in document
     *
     * @param document
     */
    ...
    /**
     * This method is used to fetch documents by default criteria
     *
     * @param clientId
     * @param active
    ...
    /**
     * This method is used to fetch documents by direct criteria
     *
     * @param clientId
     * @param active
     * @param collectionName
    ...
    /**
     * This method is used to fetch documents by indirect criteria
     *
     * @param active
     * @param collectionName
     * @param fields
